...
public class VideoInfoService extends VideoInfoServiceBase {
    ...
    private VideoInfo firstPlayable(String videoId, String clickTrackingParams) {
        AppClient beginType = mNextInfoType != null ? mNextInfoType : VIDEO_INFO_TYPE_LIST[0];
        return VideoInfoSelector.select(VIDEO_INFO_TYPE_LIST, beginType,
                client -> getVideoInfoWithRentFix(client, videoId, clickTrackingParams));
    }
