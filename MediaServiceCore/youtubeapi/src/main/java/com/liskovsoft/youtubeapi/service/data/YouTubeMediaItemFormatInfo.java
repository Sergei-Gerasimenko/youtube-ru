...
public class YouTubeMediaItemFormatInfo implements MediaItemFormatInfo {
    ...
    public static YouTubeMediaItemFormatInfo from(VideoInfo videoInfo) {
        ...
        formatInfo.mIsUnplayable = videoInfo.isAgeRestricted() || videoInfo.isVisibilityRestricted() || videoInfo.isUnknownRestricted()
                || (videoInfo.isUnplayable() && !formatInfo.containsUrlFormats());
