...
public class VideoInfo {
    ...
    public boolean isAgeRestricted() {
        return ServiceHelper.atLeastOneEquals(mPlayabilityStatus, STATUS_LOGIN_REQUIRED, STATUS_AGE_CHECK_REQUIRED, STATUS_AGE_VERIFICATION_REQUIRED, STATUS_CONTENT_CHECK_REQUIRED);
    }
